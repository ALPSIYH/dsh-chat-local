...
export function apply(ctx, config = {}) {
  ...
  // The service the plugin mounted. Returned so a test can drive the same
  // instance the registry and the routes use: a boot helper otherwise has no
  // handle on it, and a second instance over the same state file would not be
  // the one holding this room's live turn.
  return service;
}
