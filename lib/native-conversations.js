// DSH 0.1.2-rc.1 compatibility seam. No Session history, file grants, native
// presets or deployment-wide model defaults are cloned here.
...
export async function provisionConversationSession(ctx, member) {
  ...
  await selectConversationModel(ctx,member,config.model);
