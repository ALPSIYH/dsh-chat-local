window.__ModuleLoader__.load({
  ...
  const closed = status => ["done", "decided", "resolved", "archived", "cancelled", "paused"].includes(status);
  ...
  return {closed,pending,needsUser,related,kindLabel,handoffLabel,nextAction};
})();
